...
<main>
    <div class="form">
        ...
        <div class="tab-content">
            <div id="login">
                <h1>Welcome Back!</h1>
                <form action="${pageContext.request.contextPath}/ApplicationController?command=login" method="post">
            ...
            <div id="signup">
                ...
                <form action="${pageContext.request.contextPath}/ApplicationController?command=registration" method="post">
                    <div class="top-row">
                        <div class="field-wrap">
                            <label>
                                Login<span class="req">*</span>
